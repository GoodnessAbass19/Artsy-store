    ...
    <section className="mx-auto max-w-7xl lg:divide-y-2 divide-neutral-300 overflow-hidden">
      ...
      <div className="divide-y-2 divide-neutral-300 md:px-5">
        {FeaturedProduct.map((item, i) => (
          <div
            key={i}
            className="flex lg:odd:flex-row lg:even:flex-row-reverse gap-y-5 gap-x-12 flex-col justify-between mx-5 md:mx-auto md:my-20 my-10 overflow-hidden py-5"
          >
            ...
            <div className="grid gap-y-6 items-start basis-2/4 max-w-2xl">
