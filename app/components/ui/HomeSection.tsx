...
import { ProductsRes } from "../home/Featured";

interface Props {
  data: ProductsRes | undefined;
  title: string;
  boldTitle: string;
  loading: boolean;
}

const HomeSection = ({ data, boldTitle, title, loading }: Props) => {
  ...
  return (
    <div className="pt-5 md:pt-6 lg:pt-7 pb-2 md:pb-3 lg:pb-4">
      <div className="relative pt-4">
        <div className="mx-auto max-w-7xl mb-3 px-3 md:pl-5">
        ...
        <div className="w-full pl-3 md:pl-5">
          ...
          >
            ...
            {/*---- Navigation Button ----*/}
            {/*---------------------------*/}
            {data?.newArrival?.products?.map((item: any) => (
